...
const KeyResponsibilities = () => (
  <section className="mt-6 bg-white max-w-5xl mx-auto">
    ...
    <div className="space-y-5 text-gray-700 leading-6 md:leading-7 text-base md:text-lg">
      <div>
        <h4 className="font-bold text-lg text-gray-900 mb-2.5 tracking-tight">1. Lead Generation & Research</h4>
      ...
      <div>
        <h4 className="font-bold text-lg text-gray-900 mb-2.5 tracking-tight">2. Outreach & Initial Contact</h4>
        <ul className="space-y-2 ml-4">
          <li className="flex items-start">
            <span className="mr-3 text-gray-500">•</span>
      ...
      <div>
        <h4 className="font-bold text-lg text-gray-900 mb-2.5 tracking-tight">3. Lead Qualification</h4>
        <ul className="space-y-2 ml-4">
          <li className="flex items-start">
            <span className="mr-3 text-gray-500">•</span>
      ...
      <div>
        <h4 className="font-bold text-lg text-gray-900 mb-2.5 tracking-tight">4. CRM & Pipeline Management</h4>
        <ul className="space-y-2 ml-4">
          <li className="flex items-start">
            <span className="mr-3 text-gray-500">•</span>
      ...
      <div>
        <h4 className="font-bold text-lg text-gray-900 mb-2.5 tracking-tight">5. Market Analysis & Insights</h4>
        <ul className="space-y-2 ml-4">
          <li className="flex items-start">
            <span className="mr-3 text-gray-500">•</span>
